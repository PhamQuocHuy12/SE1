...
import a3_1801040104.kengine.Doc;
import a3_1801040104.kengine.DocCnt;
import a3_1801040104.kengine.Engine;
import a3_1801040104.kengine.Query;
...
public class CustomerWorkSheet {
	...
	/**
	 * @effects if objects is empty return "empty" else return a string containing
	 *          each object in this.objects one per line
	 */
	@Override
	public String toString() {
		...
		if (objects == null) {
			...
			Iterator h = objects.iterator();
			result += h.next().toString() + "\n";
		}
		return result;
	}
	...
	public Customer createCustomer(String[] data) throws NotPossibleException {
		if (data == null || data.length != 4) {
			throw new NotPossibleException("Invalid customer's data!");
		}
		try {
