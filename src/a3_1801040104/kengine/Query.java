...
public class Query {
  ...
  /**
   * A method return an Iterator of the query matches
   * @effects 	If there is a query matches
   * 				return an Iterator
   * 			else
   * 				return null		
   */
  ...
  public Iterator matchIterator() {
	  ...
	  Iterator matchesIterator = new MatchGen(this.matches);
