 ...
 */
public class ex2_3_IronSuit extends ex2_1_Vehicle implements Flyable{
    ...
    protected boolean validateSeatingCapacity(int seatCapacity){
        return validateSeatingCapacity(seatCapacity) && seatCapacity <= 1;
    }
    ...
    public ex2_3_IronSuit(@AttrRef("name") String n,
