 ...
 * @author dmle
 */
public class ex2_3_BusExtra extends Vehicle {
  private static final double MIN_WEIGHT = 5000;
  private static final double MIN_SEATCAP = 30;

  // extra attribute
  @DomainConstraint(type="Integer[]",mutable=false,min= 1, max = 100, optional=false)
  private int[] routes;
   ...
   *          </pre>
   */
  public ex2_3_BusExtra(@AttrRef("name") String n, 
